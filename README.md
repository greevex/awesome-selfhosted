...
- [openronin](https://github.com/openronin/openronin/) - AI dev teammate for GitHub. Picks up issues, asks questions, ships PRs, answers your review comments, resolves conflicts, merges when green. Self-hosted. ([Source Code](https://github.com/openronin/openronin)) `MIT` `Typescript`
